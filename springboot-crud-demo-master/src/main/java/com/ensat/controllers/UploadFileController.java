...
//	@PostMapping("/upload")
//    public String uploadMultipartFile(@RequestParam("uploadfile") MultipartFile[] files,@RequestParam("name") String name, Model model) {
//		try {
...
//    }
	...
	@PostMapping("/upload")
    public String uploadMultipartFile(@RequestParam("uploadfile") MultipartFile[] files,@RequestParam("name") String name
    		, @RequestParam("material") String material,@RequestParam("size") String size, @RequestParam("quantity") String quantity
    		, @RequestParam("city") String city,@RequestParam("address") String address,@RequestParam("phone") String phone
		...
		try {
			...
			String content = "<html> <b>Order</b> <br/>Customer name: "+ name 
